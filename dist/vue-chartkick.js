...
var createComponent = function createComponent(Vue, tagName, chartType) {
  var chartProps = ['colors', 'curve', 'decimal', 'discrete', 'donut', 'download', 'label', 'legend', 'library', 'max', 'messages', 'min', 'points', 'prefix', 'refresh', 'stacked', 'suffix', 'thousands', 'title', 'xtitle', 'xtype', 'ytitle'];
